...
import { StrategyLinkedList } from "../../../../../src/strategy/collections/lists/strategy-linked-list/strategy-linked-list";
...
describe("StrategyLinkedList (unsorted)", () => {
  test("creates an empty list by default", () => {
    const list = new StrategyLinkedList<number>();
  ...
  test("creates a list from initial elements preserving order", () => {
    const list = new StrategyLinkedList<number>([3, 1, 2]);

    expect(list.toArray()).toEqual([3, 1, 2]);
  });

  test("add appends at the end and does not sort", () => {
    const list = new StrategyLinkedList<number>([3, 1]);
  ...
  test("addAt inserts at explicit index", () => {
    const list = new StrategyLinkedList<number>([1, 3]);
  ...
  test("set replaces element at index", () => {
    const list = new StrategyLinkedList<number>([1, 2, 3]);
  ...
  test("contains/indexOf/remove use default equality behavior", () => {
    const list = new StrategyLinkedList<string>(["a", "b", "c"]);
  ...
  test("throws IndexOutOfBoundsError for invalid indexes", () => {
    const list = new StrategyLinkedList<number>([1]);
