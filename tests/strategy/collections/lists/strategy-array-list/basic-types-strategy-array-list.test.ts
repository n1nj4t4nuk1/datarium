...
import { StrategyArrayList } from "../../../../../src/strategy/collections/lists/strategy-array-list/strategy-array-list";
...
describe("StrategyArrayList (unsorted)", () => {
  test("creates an empty list by default", () => {
    const list = new StrategyArrayList<number>();
  ...
  test("creates a list from initial elements preserving order", () => {
    const list = new StrategyArrayList<number>([3, 1, 2]);

    expect(list.toArray()).toEqual([3, 1, 2]);
  });

  test("add appends at the end and does not sort", () => {
    const list = new StrategyArrayList<number>([3, 1]);
  ...
  test("addAt inserts at explicit index", () => {
    const list = new StrategyArrayList<number>([1, 3]);
  ...
  test("set replaces element at index", () => {
    const list = new StrategyArrayList<number>([1, 2, 3]);
  ...
  test("contains/indexOf/remove use default equality behavior", () => {
    const list = new StrategyArrayList<string>(["a", "b", "c"]);
  ...
  test("throws IndexOutOfBoundsError for invalid indexes", () => {
    const list = new StrategyArrayList<number>([1]);
