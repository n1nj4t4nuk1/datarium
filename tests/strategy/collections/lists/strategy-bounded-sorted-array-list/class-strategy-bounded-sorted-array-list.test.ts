...
import { StrategyBoundedSortedArrayList } from "../../../../../src/strategy/collections/lists/strategy-bounded-sorted-array-list/strategy-bounded-sorted-array-list";
...
describe("StrategyBoundedSortedArrayList with class type User", () => {
  ...
  test("orders users by age in constructor", () => {
    const list = new StrategyBoundedSortedArrayList<User>(
      3,
      orderByAge,
      [
        new User(1, "Ana", 35),
